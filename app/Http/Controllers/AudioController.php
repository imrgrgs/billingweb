...
class AudioController extends AppBaseController
{
    ...
    public function store(CreateAudioRequest $request)
    {
        ...
        Flash::success(__('messages.saved', ['model' => __('models/audio.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($audio)) {
            Flash::error(__('messages.not_found', ['model' => __('models/audio.singular')]));
    ...
    public function update($id, UpdateAudioRequest $request)
    {
        ...
        Flash::success(__('messages.updated', ['model' => __('models/audio.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('messages.deleted', ['model' => __('models/audio.singular')]));
