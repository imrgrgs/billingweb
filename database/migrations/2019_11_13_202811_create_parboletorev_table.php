...
class CreateParboletorevTable extends Migration {
	...
	public function up()
	{
		Schema::create('parboletorev', function(Blueprint $table)
		{
			...
			$table->char('bol_agencia', 5)->default(0);
