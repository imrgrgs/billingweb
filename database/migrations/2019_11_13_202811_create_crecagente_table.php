...
class CreateCrecagenteTable extends Migration {
	...
	public function up()
	{
		Schema::create('crecagente', function(Blueprint $table)
		{
			...
			$table->integer('rrv_planocontas_id')->unsigned()->nullable();
			$table->integer('rrv_bancos_id')->unsigned()->nullable();
			$table->char('rrv_previsao', 1)->nullable();
			$table->integer('rrv_empresa_id')->unsigned()->nullable();
