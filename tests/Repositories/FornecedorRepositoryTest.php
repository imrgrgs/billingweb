...
class FornecedorRepositoryTest extends TestCase
{
    ...
    public function test_read_fornecedor()
    {
        ...
        $dbFornecedor = $this->fornecedorRepo->find($fornecedor->for_id);
    ...
    public function test_update_fornecedor()
    {
        ...
        $updatedFornecedor = $this->fornecedorRepo->update($fakeFornecedor, $fornecedor->for_id);
    ...
    public function test_delete_fornecedor()
    {
        ...
        $resp = $this->fornecedorRepo->delete($fornecedor->for_id);

        $this->assertTrue($resp);
        $this->assertNull(Fornecedor::find($fornecedor->for_id), 'Fornecedor should not exist in DB');
    }
}
